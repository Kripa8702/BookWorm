...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  acceptRequest() async {
    ...
    //Send notification
    await FirebaseNotificationMethods().sendPushMessage(
        body, title, exchangeModel.exchangeId, '/chats', token);

    //Send message

    await ChatFunctions().sendMessage(exchangeModel.book2.uid,
        exchangeModel.book2.username, exchangeModel.book1.uid, body);
